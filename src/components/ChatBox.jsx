...
const ChatBox = () => {
  ...
  return (
    <>
      ...
      {showChat && (
        <motion.div
          className="fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4  p-6 rounded-lg bg-slate-100  w-[300px] h-[500px]  md:w-[400px] md:h-[700px] z-10 shadow-md transition-all duration-300 ease-in-out flex flex-col justify-between"
        ...
        >
          <div>
            ...
            <div className="overflow-y-auto flex-1 max-h-[325px] lg:max-h-[450px] scrollbar-width-none">
